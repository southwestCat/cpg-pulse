...
#define REQUIRES_REPRESENTATION(representation)                                                                  \
    const representation *the##representation = Blackboard::getInstance().the##representation.get(); \
...
#define MODIFIES_REPRESENTATION(representation)                                                            \
    representation *the##representation = Blackboard::getInstance().the##representation.get(); \
    const bool update##representation = false;
